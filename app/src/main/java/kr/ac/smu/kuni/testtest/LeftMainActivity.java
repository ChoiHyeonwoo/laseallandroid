...
public class LeftMainActivity extends MainActivity implements SensorEventListener {
        ...
        public void handleMessage(Message inputMessage) {
            ...
            switch (inputMessage.what) {
                case SimpleSocket.MessageTypeClass.SIMSOCK_CONNECTED:
                    String conmsg = (String) inputMessage.obj;
                    break;
                ...
                case SimpleSocket.MessageTypeClass.SIMSOCK_DISCONNECTED:
                    String disconmsg = (String) inputMessage.obj;
                    Toast.makeText(getApplicationContext(), disconmsg, Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        linePage = (ImageButton) findViewById(R.id.linePage);
        red_point = (ImageButton) findViewById(R.id.red_point);
        paintPage = (ImageButton) findViewById(R.id.paintPage);
        linePage = (ImageButton) findViewById(R.id.linePage);
        main_ll = (RelativeLayout) findViewById(R.id.main_ll_left);
        ...
        linePage.setOnClickListener(new View.OnClickListener() {
            public EditText input = new EditText(LeftMainActivity.this);
            @Override
            public void onClick(View v) {
                AlertDialog.Builder dlg = new AlertDialog.Builder(LeftMainActivity.this);
                dlg.setTitle("색깔선택");
                dlg.setMultiChoiceItems(colorstrings, colorselection, new DialogInterface.OnMultiChoiceClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which, boolean isChecked) {
                        Toast.makeText(getApplicationContext(), colorstrings[which], Toast.LENGTH_SHORT).show();
                ...
                dlg.setPositiveButton("ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        for (int i = 0; i < colorstrings.length; i++) {
                            if (colorselection[i] == true) {
                                result += colorstrings[i] + ", ";
                            }
                        }
                        result += "를 선택하셨습니다.";
                    }
                ...
                dlg.show();
                AlertDialog.Builder dlg2 = new AlertDialog.Builder(LeftMainActivity.this);
                dlg2.setTitle("크기선택");
                dlg2.setMultiChoiceItems(sizestrings, sizeselection, new DialogInterface.OnMultiChoiceClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which, boolean isChecked) {
                        Toast.makeText(getApplicationContext(), sizestrings[which], Toast.LENGTH_SHORT).show();
                ...
                dlg2.setPositiveButton("ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        for (int i = 0; i < sizestrings.length; i++) {
                            if (sizeselection[i] == true) {
                                result += sizestrings[i] + ", ";
                            }
                        }
                        result += "를 선택하셨습니다.";
                    }
                ...
                dlg2.show();
                AlertDialog.Builder dlg3 = new AlertDialog.Builder(LeftMainActivity.this);
                dlg3.setTitle("텍스트입력");
                dlg3.setMessage("Message");

                dlg3.setView(input);
                dlg3.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        String value = input.getText().toString();
                        ssocket.sendString(value);
                        // Do something with value!
                    }
                });
                dlg3.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        // Canceled.
                    }
                });
    ...
    void openDialog(boolean supportsAlpha) {
        AmbilWarnaDialog dialog = new AmbilWarnaDialog(LeftMainActivity.this, color, supportsAlpha, new AmbilWarnaDialog.OnAmbilWarnaListener() {
            @Override
            public void onOk(AmbilWarnaDialog dialog, int color) {
                //Toast.makeText(getApplicationContext(), "ok", Toast.LENGTH_SHORT).show();
                LeftMainActivity.this.color = color;
